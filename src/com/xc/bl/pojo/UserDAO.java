...
public class UserDAO extends BaseHibernateDAO {
	...
	public User findById(java.lang.Long id) {
		...
		try {
			User instance = (User) getSession().get("com.xc.bl.pojo.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession().createCriteria("com.xc.bl.pojo.User")
	...
	public List findByUserSid(Object userSid) {
		return findByProperty(USER_SID, userSid);
	}
